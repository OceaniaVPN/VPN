...
function pageHtml(origin, plan) {
  ...
  const metadataUrl = `${origin}/sub/${plan}/metadata`;
...
async function subscriptionResponse(request, plan) {
  ...
  const response = new Response(json + "\n", {
    headers: {
      ...
      "link": `</sub/${plan}/metadata>; rel="profile"`
    }
  });
